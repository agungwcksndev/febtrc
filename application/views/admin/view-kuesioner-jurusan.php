       ...
       <div class="col-xs-12">
         <div class="box box-info">
           <div class="box-header">
             <h3 class="box-title">Paket Kuesioner Jurusan</h3>
...
<div class="modal fade" id="modal-add-paket" role="dialog">
  <div class="modal-dialog">
    <form class="" action="<?php echo site_url('admin/kuesioner_jurusan/add_paket_soal') ?>" method="post">
...
<div class="modal fade" id="modal-update-paket" role="dialog">
  <div class="modal-dialog">
    <form class="" action="<?php echo site_url('admin/kuesioner_jurusan/update_paket_soal') ?>" method="post">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <button type="button" class="close" data-dismiss="modal" name="button"></button>
...
<script>
 ...
 function edit_paket(id_paket)
 {
     ...
     $.ajax({
         url : "<?php echo site_url('admin/kuesioner_jurusan/getDetailPaket')?>/" + id_paket,
         type: "GET",
         dataType: "JSON",
 ...
 function del(id) {
      ...
      if (r == true) {
          window.location = url+"/admin/kuesioner_jurusan/delete_paket_soal/"+id;
      } else {
          return false;
      }
  }
